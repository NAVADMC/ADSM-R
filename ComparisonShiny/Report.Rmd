...
```{r,echo=F}
net1<-graph.data.frame(S1farm[S1farm$Scenario %in% params$scenario_variable,],directed=F)#specified edges of a directed farm
  net2<-graph.data.frame(S2farm[S2farm$Scenario %in% params$scenario_variable,],directed=F)#specified edges of a directed farm
  net3<-graph.data.frame(S3farm[S3farm$Scenario %in% params$scenario_variable,],directed=F)#specified edges of a directed farm
  net4<-graph.data.frame(S4farm[S4farm$Scenario %in% params$scenario_variable,],directed=F)#specified edges of a directed farm
